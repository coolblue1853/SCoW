...
public class DialogManager_sub : MonoBehaviour
{


    private static DialogManager_sub instance = null;
    private void Awake()
    {
    ...
    public static DialogManager_sub Instance
    {
        get
        {
            if (null == instance)
  ...
  //  public GameObject 엘라심리학선택지버튼;
    ...
    public void EndDialog()
    {
        ...
        if(DataBaseManager.NowSelecter != "End")
        {
