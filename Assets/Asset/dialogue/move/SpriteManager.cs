...
public class SpriteManager : MonoBehaviour
{
    ...
    */
    ...
    /*
public void 노아일러스트13()
{

    일러스트송출(노아표정13);
}

public void 노아일러스트14()
{

    일러스트송출(노아표정14);
}

public void 노아일러스트15()
{

    일러스트송출(노아표정15);
}
public void 노아일러스트16()
{

    일러스트송출(노아표정16);
}

public void 노아일러스트17()
{

    일러스트송출(노아표정17);
}

public void 노아일러스트18()
{

    일러스트송출(노아표정18);
}

public void 노아일러스트19()
{

    일러스트송출(노아표정19);
}

public void 노아일러스트20()
{

    일러스트송출(노아표정20);
}

public void 노아일러스트21()
{

    일러스트송출(노아표정21);
}

public void 노아일러스트22()
{

    일러스트송출(노아표정22);
}

public void 노아일러스트23()
{

    일러스트송출(노아표정23);
}

public void 노아일러스트24()
{
...
*/
    ...
    public void allReset()
    {
        ...
        노아표정13.SetActive(false);
        노아표정14.SetActive(false);
        노아표정15.SetActive(false);
        노아표정16.SetActive(false);
        노아표정17.SetActive(false);
        노아표정18.SetActive(false);
        노아표정19.SetActive(false);
        노아표정20.SetActive(false);
        노아표정21.SetActive(false);
